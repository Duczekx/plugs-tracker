      ...
      <div className="app-content">
        <section className="card card-narrow">
          <div className="card-header">
            <div>
              <h1 className="title title-with-icon">{t.editorLoginTitle}</h1>
              <p className="subtitle">{t.editorLoginSubtitle}</p>
            </div>
          ...
          {error === "invalid" && <div className="alert">{t.editorLoginError}</div>}
          {error === "missing" && <div className="alert">{t.editorLoginMissing}</div>}
